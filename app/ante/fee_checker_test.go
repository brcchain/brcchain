...
func TestSDKTxFeeChecker(t *testing.T) {
	...
	minGasPrices := sdk.NewDecCoins(sdk.NewDecCoin("abrc", sdk.NewInt(10)))
	...
	testCases := []struct {
		...
		},
		{
			...
			func() sdk.Tx {
				...
				txBuilder.SetFeeAmount(sdk.NewCoins(sdk.NewCoin("abrc", sdk.NewInt(10))))
		...
		},
		{
			...
			func() sdk.Tx {
				txBuilder := encodingConfig.TxConfig.NewTxBuilder()
				txBuilder.SetGasLimit(1)
				txBuilder.SetFeeAmount(sdk.NewCoins(sdk.NewCoin("abrc", sdk.NewInt(10).Mul(types.DefaultPriorityReduction).Add(sdk.NewInt(10)))))
				return txBuilder.GetTx()
			},
			"10000010abrc",
			10,
		...
		},
		{
			...
			func() sdk.Tx {
				...
				txBuilder.SetGasLimit(1)
				txBuilder.SetFeeAmount(sdk.NewCoins(sdk.NewCoin("abrc", sdk.NewInt(10).Mul(types.DefaultPriorityReduction))))
